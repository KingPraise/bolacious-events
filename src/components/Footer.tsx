    ...
    <footer className="relative mt-20 bg-[#1A051D] text-white pt-24 pb-12 overflow-hidden">
      ...
      <div className="absolute top-0 left-0 w-full overflow-hidden leading-none z-0">
        <svg
          ...
          className="relative block w-[110%] h-[80px] md:h-[120px] -ml-[5%]"
        >
          {/* Top section matching page background to blend smoothly */}
          <rect width="1200" height="120" className="fill-background" />
          <path
            ...
            className="fill-secondary/20 animate-wave-1"
          ></path>
          <path
            ...
            className="fill-primary/60 animate-wave-2"
          ></path>
          <path
            ...
            className="fill-[#1A051D] animate-wave-3"
          ></path>
        </svg>
      </div>
